...
|------|-------|------|----------|--------|
| [P007](plans/P007.json) | position_lost look never fires on repeated no-room extractions | lost_position | high | open |
| [P008](plans/P008.json) | Re-examine exits after combat-forced relocation | nav_contradiction | medium | open |
