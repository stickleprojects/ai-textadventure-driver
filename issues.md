...
1. the engine is reading the horse, and looking inside the horse, it should recognize that a horse cannot be read
...
7. the engine doesnt understand "you cant do that", "you cant see the huge knight" - again symptom of not undersatnding npc vs object
